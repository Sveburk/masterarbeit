...
def debug_print_standalone_roles(
    transcript_text: str, roles: List[Dict[str, Any]]
):
    ...
    for r in roles:
        ...
        context_lines = [
            line for line in transcript_text.splitlines() if r["role"] in line
        ]
