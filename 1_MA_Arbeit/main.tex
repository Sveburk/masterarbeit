...
% CSV links von init
\node[source, below=2.5cm of joinpoint] (CSV) {\textbf{Groundtruth CSV} \\ known places};
...
\node[source, below= 3.6cm of joinpointxml] (CSV) {\textbf{Groundtruth CSV}\\export-organisationen.csv};
