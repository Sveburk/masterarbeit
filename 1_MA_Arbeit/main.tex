...
erster Korpus von 137 Akten\footnote{Weiterführend vgl. \cite{burkhardt_arcgis_2022}}. Als Akte werden hier Schriftstücke betitel, die entweder durch ihren Inhalt, oder die Fundsituation eindeutig als zusammengehörig betrachtet werden können. So liegt Akte\_001 beispielsweise in einer separaten Mappe und umfasste 96 Seiten, 
während andere Akten nur aus einer einzelnen Seite bestehen können. Mit diesem Prinzip entsteht 2018 eine erste Liste, die die Seiten mit deren Lage im Ordner, 
einem Kurztitel und einem Entstehungsdatum versieht. 2022 wird im Rahmen eines zweiten Seminars die Feldpost untersucht.
...
Wikidata (Beispiel:\cite{burkhardt_78th_2024}),\\\indent{\cite{altenburger_lexikon_nodate-1}},\\\indent{\cite{hermans_forum_nodate}}} konsultiert und ebenfalls erweitert. 
