...
\begin{scope}
% --- Kopf-Node ---
\node[large] (logger) at (0,0) {\textbf{log\_unmatched\_entities} \\ (Starte Logging aller Entitätstypen)};
...
\end{scope}
\end{tikzpicture}}
\captionof{figure}\small{Prozessdiagramm für \texttt{unmatched\_logger.py}}
\label{fig:unmatched_logger.py}
\smallskip

\small{Oben rechts: Pipelineübersicht}
\end{minipage}
