...
\section{Quellenbeschreibung und Korpusaufbau}
  \subsection{Beschreibung des Archivbestands}
    ...
    \noindent \textbf{\ding{43} Beispiel 1}: 9. Oktober 1940, 20.10.1940, den 3. Mai 1938, etc.\\
    ...
    \noindent\textbf{\ding{43} Beispiel 1}: Offensichtliche Tippfehler, wenn sie im Originaltext so vorkommen:  
    „Wir haben \textbf{\textless sic\textgreater einen \textless /sic\textgreater} große Freude.“\\
    
    \textbf{\ding{43} Beispiel 2}: Veraltete oder falsche Schreibweisen:  
...
\textbf{\ding{43} Beispiel 1}: Offensichtliche Tippfehler, wenn sie im Originaltext so vorkommen:  
„Er hatt \texttt{\textless sic\textgreater} einen \texttt{\textless /sic\textgreater} große Freude.“\\
\textbf{\ding{43} Beispiel 2}: Veraltete oder falsche Schreibweisen: „\textbf{\textless sic\textgreater Feber\textless /sic\textgreater}“ für Februar.\\
\textbf{\textbf{\ding{43} Beispiel 3}}: Falls eine Korrektur notwendig ist, kann sie als Kommentar ergänzt werden. \\
Carl\\
