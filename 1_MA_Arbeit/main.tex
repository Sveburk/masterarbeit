...
\addbibresource{assets/Literature_Bib/Exportierte Einträge.bib}
% Optional:
\let\cite\footcite
...
Die vorliegende Arbeit beschäftigt sich mit Unterlagen aus dem Archiv des \endquote{Männerchor Murg} und dessen Nachfolger, den \endquote{New Gospelsingers Murg}. Murg ist eine Gemeinde am Hochrhein, rund 30 km Luftlinie von Basel entfernt.
...
im Verlauf des Projekts als ungeeignet erwiesen. Transparenz ist hierbei ein wesentlicher Aspekt: Ein großer Teil der 
...
Insbesondere OWL DL bietet einen praktikablen Mittelweg zwischen hoher Ausdruckskraft und vollständigem, entscheidbarem Schließen (Reasoning) 
...
große Mengen an semantisch verknüpften Daten effizient zu verwalten. 
...
zu klein, um daraus eine aussagekräftige Netzwerkanalyse zu machen. Hierfür erweisen sich die Unterschiede der Daten zusätzlich als zu gross und damit aufwendig. Der Fokus der Arbeit verschiebt sich dementsprechend von der Ontologieentwicklung 
...
\begin{minipage}{0.48\textwidth}% Rechte Box = BILD
  ...
  \captionof{figure}{Ausschnitt der TTL-Ontologie.}
...
über militärische Einheiten und deren Feldpostnummern sind das „Forum der Wehrmacht“\cite[Vgl.][]{altenburger_lexikon_nodate-1} 
und der „Suchdienst des DRK“\cite[Vgl.][]{reuter_drk_2025}. In beiden Fällen liegen die Daten jedoch nicht als LOD vor, sondern im Forum als einfache Strings 
...
\textit{\enquote{Wikidata stands out for its great potential in interoperability and its ability to connect data from various domains.}}
\cite{martinez_comparative_nodate}
...
Die praktische Umsetzung zeigt jedoch eine strukturelle Einschränkung: Trotz systematischer Verknüpfung eigens angelegter Datensätze, 
etwa mit Armeen, Militäreinheiten, Orten und Personen, entfernt die Community–Moderation etwa 70\% dieser Beiträge. 
Dies verweist auf die hohen internen Qualitätsanforderungen, begrenzt jedoch die Verlässlichkeit und den Nutzen der Arbeit erheblich. 
...
\subsubsection{Msty}  
Ein absolut zentrales Tool bei der Verarbeitung der historischen Quellen ist die unten dargelegte Python–Pipeline, die auf der
Verarbeitung von XML–Files fusst.
...
Abreviation Tag klappt nicht (wird nicht exportiert)
Listen werden nicht exportiert
...
In Transkribus-Seminaren am Departement Geschichte der Universität Basel wird aus \textit{\endquote{Männerchor Akten 1925-1944}} bereits 2018 und 2022 ein 
...
Während der Fokus 2028 auf den augenscheinlich häufig auftretenden Personennamen \endquote{Carl Burger} und \endquote{Fritz Jung} liegt, wird 2022 im Rahmen eines zweiten Seminars spezifischer die Feldpost untersucht.
...
\section{Methodischer Zugang}
    ...
    \textbf{\ding{43} Beispiel 2}: Organisationskürzel, wenn sie eindeutig sind:\ldots\colorbox{VeryLightGray}{\textless abbrev\textgreater V.D.A.\textless /abbrev\textgreater}.
...
% Event
    ...
    \colorbox{VeryLightGray}{„Er wohnte in\textless unclear\textgreater [\ldots]\textless unclear\textgreater“.}

    \textbf{\ding{43} Beispiel 2}: Teilweise lesbare Wörter:

    \colorbox{VeryLightGray}{"{\textless place\textgreater Frei\textless unclear\textgreater [\ldots]\textless unclear\textgreater \textless place\textgreater}“.}
...
Aus diesem Grund wurden 75 Akten zunächst mit dem Modell „The German Giant I“ mit einer CER von 8,30\,\% transkribiert. Mit insgesamt vier Iterationen wurde eine Groundtruth 
...
Durch ChatGPT verliert der Text zwar seine ursprüngliche Formatierung und Zeilenumbrüche, aber wird nun nahezu fehlerfrei lesbar. Nur das \endquote{Venstadler Liedchen} ist eigendlich eines aus \endquote{Neustadt}. Eine anschliessende menschliche Korrektur ermöglicht also den Abgeleich mit dem nun lesbaren Text, und die Korrektur der Transkribtion.
...
sangen \endquote{auf Wiederschen} Obwohl ich  \textbf{\colorbox{unclear}{\texttt{Frank-}}}\\
marke beifügte, keine Antwort. Vielleicht\\
gelingt es Dir diesen Titel zu erhalten.\\
Weiterhin sänge ich das Lied nur\\
\endquote{Das alte Lied} von  \textbf{\colorbox{abbrev}{\texttt{Komp.}}}\textbf{\colorbox{person}{\texttt{ Kirchl}}}\\
