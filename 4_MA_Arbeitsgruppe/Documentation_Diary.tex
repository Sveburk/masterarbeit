...
\tikzset{
  ...
  arrowboth/.style={<->, line width=0.15mm},
  process/.style={rectangle, draw=black, fill=orange!20, thick, minimum width=6cm, minimum height=1cm, align=center},
...
\node[module] (xml) at (0, -1) {};
\node[module]    (events)  at (-3.3, -2) {};
\node[module]    (roles)   at (-1.9, -2) {};
\node[highlight] (persons) at (-0.5, -2) {};
\node[module]    (orgs)    at (0.9, -2) {};
\node[module]    (places)  at (2.3, -2) {};
\node[module]    (dates)   at (3.7, -2) {};
\node[module] (authors) at (-0.5, -3) {};
\node[module] (json)    at (-0, -4.0) {};
\node[module] (save)    at (-0, -5.2) {};
\node[coordinate] (joinpoint) at ($(xml.south) + (0, -2.3cm)$) {};
